                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                <button
                                    ...
                                    className={`relative p-10 rounded-[2.5rem] text-left transition-all duration-500 overflow-hidden group border-4 ${formData.type === ProjectType.CHARITY
                                        ? 'border-emerald-600 bg-emerald-50/30'
                                        : 'border-slate-50 bg-slate-50/30 hover:bg-emerald-50/10 hover:border-emerald-200'
                                        }`}
                                >
                                    <div className={`w-20 h-20 rounded-3xl flex items-center justify-center mb-8 transition-all duration-500 ${formData.type === ProjectType.CHARITY ? 'bg-emerald-600 text-white shadow-2xl shadow-emerald-500/40 rotate-6' : 'bg-white text-slate-400 border-2 border-slate-100'}`}>
                                        <Heart size={40} />
                                    </div>
                                    <h3 className="text-3xl font-black text-slate-900 mb-4 tracking-tight">Charity</h3>
                                ...
                                <button
                                    ...
                                    className={`relative p-10 rounded-[2.5rem] text-left transition-all duration-500 overflow-hidden group border-4 ${formData.type === ProjectType.ROI
                                        ? 'border-blue-600 bg-blue-50/30'
                                        : 'border-slate-50 bg-slate-50/30 hover:bg-blue-50/10 hover:border-blue-200'
                                        }`}
                                >
                                    <div className={`w-20 h-20 rounded-3xl flex items-center justify-center mb-8 transition-all duration-500 ${formData.type === ProjectType.ROI ? 'bg-blue-600 text-white shadow-2xl shadow-blue-500/40 -rotate-6' : 'bg-white text-slate-400 border-2 border-slate-100'}`}>
                                        <TrendingUp size={40} />
                                    </div>
                                    <h3 className="text-3xl font-black text-slate-900 mb-4 tracking-tight">Investment / ROI</h3>
                                    <p className="text-slate-500 font-medium leading-relaxed mb-8">
                    ...
                    {step === 2 && (
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h2 className="text-3xl font-black text-gray-900 leading-tight">Project Identity</h2>
                                    <p className="text-gray-500 font-medium">Tell us the core details of your {formData.type} project.</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-8 text-left max-w-2xl mx-auto">
                                <div className="grid grid-cols-2 gap-10 p-10 bg-gray-50/50 rounded-[3rem] border border-gray-100 ring-1 ring-white/50 backdrop-blur-sm">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xl font-black text-gray-900 uppercase tracking-tight">{formData.currency} {formData.targetAmount.toLocaleString()}</p>
                                    </div>
                                    <div>
