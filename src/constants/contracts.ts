// Replacement contracts are intentionally unconfigured until reviewed testnet deployments exist.
export const ESCROW_ADDRESS: `0x${string}` | undefined = undefined;
...
export const INVESTMENT_NFT_ADDRESS: `0x${string}` | undefined = undefined;
